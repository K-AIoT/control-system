#POTENTIALLY MOVE TO WITHIN BRIDGE.PY
...
def makeClient(clientName, mqttBrokerIp):
    ...
    client.loop_start() # Starts the MQTT client's background thread, allowing MQTT client to operate asynchronously.                                                                                       
    return client   
...
def on_disconnect(client, userdata, rc):
    ...
    client.loop_stop() # Stops the MQTT client's background thread.
